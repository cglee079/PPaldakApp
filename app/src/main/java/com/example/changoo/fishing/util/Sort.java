...
public class Sort {
    ...
    public static Comparator<Fish> maxDesc = new Comparator<Fish>() { //Max로 내림차순 정렬
        @Override
    ...
    public static Comparator<Fish> nameAsc = new Comparator<Fish>() { //name으로 오름차순
    ...
    public static Comparator<Fish> speciesAsc = new Comparator<Fish>() { //speces으로 오름차순
