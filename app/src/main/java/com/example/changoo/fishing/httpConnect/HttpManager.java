...
public class HttpManager {
    ...
    public static String getJoinURL() { return JoinURL; }

    public static String getDeleteFishURL() { return deleteFishURL; }

    public static String getSaveUser() { return saveUser; }
}
