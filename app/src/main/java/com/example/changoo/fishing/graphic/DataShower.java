...
public class DataShower extends View {
    ...
    private void drawArc(Canvas canvas, int start_angle, int angleMount, int color) {
        ...
        float forCenter = 0;
        float sizeUp = 0;
        canvas.drawArc(gapForSquare - sizeUp, 0.0f + forCenter - sizeUp, WIDTH - gapForSquare + sizeUp, HEIGHT + forCenter + sizeUp, start_angle, angleMount, true, paint);
        paint.setColor(Color.WHITE);
        canvas.drawArc(gapForSquare + gapInAndOut - sizeUp, 0.0f + gapInAndOut + forCenter - sizeUp, WIDTH - gapForSquare - gapInAndOut + sizeUp, HEIGHT - gapInAndOut + forCenter + sizeUp, start_angle, 360, true, paint);
